...
interface Props { videoRef: React.RefObject<HTMLVideoElement | null>; subtitles: SubtitleTrack[]; selectedSubtitle: string | null; onSubtitleSelect: (lang: string | null) => void; onSubtitlesChange: (tracks: SubtitleTrack[]) => void; tmdbId?: string; season?: number; episode?: number; title?: string; imdbId?: string; }
export function SubtitleSelector({ videoRef, subtitles, selectedSubtitle, onSubtitleSelect, onSubtitlesChange, tmdbId, season, episode, title, imdbId }: Props) {
