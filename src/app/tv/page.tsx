...
const SPECIAL_GENRES: Category[] = [
    { id: '16', name: 'Animation' }, 
    { id: '16-adult', name: 'Adult Animation' },
];
    ...
    const promises = TV_GENRES.map(async (genre) => {
        try {
            ...
            while (processedVideos.length < CAROUSEL_FETCH_LIMIT && page <= 5) {
                const rawMedia: TMDBMedia[] = await getVideosByGenre(genre.id, 'tv', false, page);
  ...
  return (
    <div className="container max-w-screen-2xl py-8 md:py-12">
      ...
      <div className="flex flex-col gap-8 md:gap-12 lg:gap-16">
        {[...TV_GENRES, ...SPECIAL_GENRES].map(genre => {
