// Ambient declarations to unify multiple copies of unified-download across workspace
...
declare module 'src/lib/unified-download' {
  export * from '@/lib/unified-download';
  const _default: any;
  export default _default;
}

declare module 'spa/src/lib/unified-download' {
  export * from '@/lib/unified-download';
  const _default: any;
  export default _default;
}
